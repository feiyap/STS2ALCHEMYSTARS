...
public class LimbusCompanyHeadquarters : ModAncientEventTemplate
{
	public const string RunHistoryIconPath = "res://Valencina/images/ui/run_history/limbus_company_headquarters.png";

	public const string RunHistoryIconOutlinePath = "res://Valencina/images/ui/run_history/limbus_company_headquarters_outline.png";

	public const string BackgroundScenePath = "res://scenes/events/background_scenes/limbus_company_headquarters.tscn";
	...
	public override EventAssetProfile AssetProfile => new EventAssetProfile((string)null, (string)null, "res://scenes/events/background_scenes/limbus_company_headquarters.tscn", (string)null);

	public override AncientEventPresentationAssetProfile AncientPresentationAssetProfile => new AncientEventPresentationAssetProfile("res://Valencina/images/ui/run_history/limbus_company_headquarters.png", "res://Valencina/images/ui/run_history/limbus_company_headquarters_outline.png", "res://Valencina/images/ui/run_history/limbus_company_headquarters.png", "res://Valencina/images/ui/run_history/limbus_company_headquarters_outline.png", (AncientEventStageProceduralVisualSet)null);
	...
	{
		((ModAncientEventTemplate)this).CreateModRelicOption<Outlaw>("INITIAL"),
		((ModAncientEventTemplate)this).CreateModRelicOption<Rainstorm>("INITIAL").ThatDoesDamage(20m),
		((ModAncientEventTemplate)this).CreateModRelicOption<FlameScale>("INITIAL").ThatDoesDamage(20m)
	};

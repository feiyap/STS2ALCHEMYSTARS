...
public class ThumbAdvisor : ModAncientEventTemplate
{
	public const string RunHistoryIconPath = "res://Valencina/images/ui/run_history/thumb_advisor.png";

	public const string RunHistoryIconOutlinePath = "res://Valencina/images/ui/run_history/thumb_advisor_outline.png";

	public const string BackgroundScenePath = "res://scenes/events/background_scenes/thumb_advisor.tscn";
	...
	public override EventAssetProfile AssetProfile => new EventAssetProfile((string)null, (string)null, "res://scenes/events/background_scenes/thumb_advisor.tscn", (string)null);

	public override AncientEventPresentationAssetProfile AncientPresentationAssetProfile => new AncientEventPresentationAssetProfile("res://Valencina/images/ui/run_history/thumb_advisor.png", "res://Valencina/images/ui/run_history/thumb_advisor_outline.png", "res://Valencina/images/ui/run_history/thumb_advisor.png", "res://Valencina/images/ui/run_history/thumb_advisor_outline.png", (AncientEventStageProceduralVisualSet)null);
	...
	{
		((ModAncientEventTemplate)this).CreateModRelicOption<ThumbBadge>("INITIAL"),
		((ModAncientEventTemplate)this).CreateModRelicOption<AdvisorsDecision>("INITIAL"),
		((ModAncientEventTemplate)this).CreateModRelicOption<BernoulliTraining>("INITIAL")
	};

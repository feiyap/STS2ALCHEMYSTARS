...
public sealed class Maggot : RienRelic
{
	public const decimal EnemyMaxHpMultiplier = 1.05m;

	protected override IEnumerable<DynamicVar> CanonicalVars => new _003C_003Ez__ReadOnlySingleElementList<DynamicVar>(new DynamicVar("Percent", 5m));

...
[HarmonyPatch]
internal static class ValencinaWarDifficultyCharacterRefreshPatch
{
	private static MethodBase TargetMethod()
	{
		return AccessTools.Method(typeof(StartRunLobby), "SetLocalCharacter", (Type[])null, (Type[])null);
	}
	...
	private static void Postfix(StartRunLobby __instance, bool __state)
	{
		...
		if (__state && (int)__instance.NetService.Type != 3 && __instance.Ascension != 11)
		{

...
public sealed class AlchemyStarsStrike : ModCardTemplate
{
    ...
    // 卡图资源。
    // 如果你按这行代码写，文件名就对应 AlchemyStars/images/cards/AlchemyStarsStrike.png。
    // 这里的 res://AlchemyStars/... 是 Godot 资源路径，对应的是你的资源文件夹名字。
    ...
    public AlchemyStarsStrike() : base(BaseEnergyCost, CardKind, CardRarityValue, CardTarget, ShowInCardLibrary)
    {
    }

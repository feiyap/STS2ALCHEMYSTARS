...
public sealed class AlchemyStarsCardPool : TypeListCardPoolModel
{
    ...
    public override string Title => "AlchemyStars";
    ...
    public override Color DeckEntryCardColor => AlchemyStarsCharacter.ThemeColor;

...
[RegisterCharacter]
public sealed class AlchemyStarsCharacter : ModCharacterTemplate<AlchemyStarsCardPool, AlchemyStarsRelicPool, AlchemyStarsPotionPool>
{
    public static readonly Color ThemeColor = new(0.13f, 0.17f, 0.21f);
    ...
    private const string CharacterScenePath = $"{SceneRoot}/AlchemyStars_character.tscn";
    private const string EnergyCounterScenePath = $"{SceneRoot}/AlchemyStars_energy_counter.tscn";
    private const string MerchantScenePath = $"{SceneRoot}/AlchemyStars_merchant.tscn";
    private const string RestSiteScenePath = $"{SceneRoot}/AlchemyStars_rest_site.tscn";
    private const string CharacterSelectBgScenePath = $"{SceneRoot}/AlchemyStars_character_select_bg.tscn";
    ...
    public override CharacterAssetProfile AssetProfile => new(
        ...
        Ui: new CharacterUiAssetSet(
            ...
            // 人物选择图标。
            CharacterSelectIconPath: $"{ImageRoot}/AlchemyStars_character_select.png",
            // 人物选择图标-锁定状态。
